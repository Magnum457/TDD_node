...
// middleware que após terminar essa operação pode ir para a próxima requisição de forma não bloqueante.
router.get('/', (ctx, next) => {
...
// exporta o server para que seja possível acessá-lo em outras partes do programa
